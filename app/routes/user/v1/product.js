...
router.get(
  "/excel",
  ProductController.getExcelProducts.bind(ProductController)
);
 ...
 * @apiDescription upload file excel that contains your list of product.The excel file should contains; name, activity status ('فعال' or 'غیر فعال'), sellingPrice, last edit date, description, checkWarehouse ('بله' or 'خیر') and direct ('بله' or 'خیر'). They should be all in order, just like the output excel of products
 * @apiGroup product
...
router.post(
  "/uploadExcel",
  uploadFile,
  ProductController.uploadExcel.bind(ProductController)
);
